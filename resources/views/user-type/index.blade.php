                            ...
                            <table class="table">
                                ...
                                @foreach($usertype as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/user-type/' . $item->id) }}" title="View UserType"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/user-type/' . $item->id . '/edit') }}" title="Edit UserType"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('/admin/user-type' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
